...
CXXFLAGS=--std=c++0x -Wall -O3 $(INC) -DGLEW_STATIC
...
SRCS_GAME=game/Client.cc game/Graphics.cc game/Main.cc game/Map.cc game/Math.cc game/Sim.cc
...
server:  $(OBJS_COMMON) $(OBJS_SERVER)
	$(CXX) $(OBJS_COMMON) $(OBJS_SERVER) $(LIB) $(LIBS_SERVER) -o game
